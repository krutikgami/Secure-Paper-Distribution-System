...
import SignupImg from '../Lottie/Signup_img.json';
      ...
      <section className="bg-gray-200 min-h-screen flex items-center justify-center p-4">
        <div className="flex flex-col lg:flex-row items-center justify-center w-full space-y-6 lg:space-y-0 lg:space-x-6">
          <div className="w-full lg:w-1/2 flex justify-center">
            <Lottie animationData={SignupImg} loop={true} className="w-full max-w-xs lg:max-w-md" />
          </div>
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                  ...
                  <Link to="/admin-login" className="font-medium text-primary-600 hover:underline dark:text-primary-500 ml-16">
                    Admin Login?
                  </Link>
                </p>
              </form>
